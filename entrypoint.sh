...
export GLUETUN_CONTAINER WG_CONF_PATH CHECK_URL CHECK_INTERVAL_SECONDS FAIL_THRESHOLD LOG_LEVEL LOG_DIR
export PIA_USERNAME PIA_PASSWORD PIA_REGION PIA_WG_CONFIG_BIN PIA_WG_CONFIG_URL PIA_WG_CONFIG_SHA256 SELF_TEST
