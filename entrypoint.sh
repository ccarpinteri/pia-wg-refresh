...
export DOCKER_COMPOSE_HOST_DIR DOCKER_COMPOSE_ENV_FILE
export ON_FAILURE_SCRIPT ON_RECOVERY_SCRIPT ON_PORT_CHANGE_SCRIPT
export GLUETUN_CONTROL_SERVER_HOST
...
mkdir -p "$LOG_DIR"
touch "$LOG_DIR/refresh.log" "$LOG_DIR/pia-wg-config.log" "$LOG_DIR/docker.log" "$LOG_DIR/hooks.log"
